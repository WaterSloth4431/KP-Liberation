...
switch (KP_liberation_preset_blufor) do {
    case  1: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\IFA3_US.sqf";};
	case  2: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\IFA3_GER.sqf";};
	case  3: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\IFA3_RUS.sqf";};
    default  {[] call compileFinal preprocessFileLineNumbers "presets\blufor\IFA3_US.sqf";};
};

switch (KP_liberation_preset_opfor) do {
    case  1: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\IFA3_GER.sqf";};
	case  2: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\IFA3_US.sqf";};
	case  3: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\IFA3_RUS.sqf";};
    default  {[] call compileFinal preprocessFileLineNumbers "presets\opfor\IFA3_GER.sqf";};
};

switch (KP_liberation_preset_resistance) do {
    case  1: {[] call compileFinal preprocessFileLineNumbers "presets\resistance\IFA3_FFI.sqf";};
    default  {[] call compileFinal preprocessFileLineNumbers "presets\resistance\IFA3_FFI.sqf";};
};

switch (KP_liberation_preset_civilians) do {
    case  1: {[] call compileFinal preprocessFileLineNumbers "presets\civilians\IFA3_CIV.sqf";};
    default  {[] call compileFinal preprocessFileLineNumbers "presets\civilians\IFA3_CIV.sqf";};
};
