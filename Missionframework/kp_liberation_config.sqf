...
/* BLUFOR preset:
0  = Default (IFA3 US)
1  = IFA3 US (Iron Front Allies with Faces of war compatablility)
2  = IFA3 GER (Iron Front Germans with Faces of war compatablility)
3  = IFA3 RUS (Iron Front Russians with Faces of war compatablility)
*/
KP_liberation_preset_blufor = 1;

/* OPFOR preset:
0  = Default (IFA3 GER)
1  = IFA3 GER (Iron Front Germans)
2  = IFA3 US (Iron Front Allies)
3  = IFA3 RUS (Iron Front Russians) */
KP_liberation_preset_opfor = 1;

/* Resistance preset:
0  = Default (IFA3 FFI)
1  = IFA3 FFI (Iron Front French Resistance) */
KP_liberation_preset_resistance = 1;

/* Civilians preset:
0  = Default (IFA3 CIV)
1  = IFA3 CIV (Iron Front Civilians) */
KP_liberation_preset_civilians = 1;

/* Which arsenal preset should be used?
0  = Use the default blacklist method (DO NOT USE)
1  = IFA3 US & UK w/ ace, GEIST, FOW arsenal preset
2  = IFA3 German w/ ace, GEIST, FOW arsenal preset
3  = IFA3 Russian w/ ace, GEIST, FOW arsenal preset */
