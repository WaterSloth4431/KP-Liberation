...
switch (KP_liberation_arsenal) do {
    case  1: {[] call compileFinal preprocessFileLineNumbers "arsenal_presets\IFA3_US_UK.sqf";};
    case  2: {[] call compileFinal preprocessFileLineNumbers "arsenal_presets\IFA3_GER.sqf";};
    case  3: {[] call compileFinal preprocessFileLineNumbers "arsenal_presets\IFA3_RUS.sqf";};
